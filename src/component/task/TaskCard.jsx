      ...
      <div className="flex flex-col md:flex-row  max-w-6xl items-center text-xs gap-3 ">
        ...
        {!buttonDisabled && !check && (
          <motion.button
            whileTap={{ scale: 0.95 }}
            className={
              " px-3 capitalize font-semibold font-stretch-150% rounded-full text-xs border border-green-500/40  bg-black/70 text-white hover:bg-white/10"
            }
        ...
        {buttonDisabled && (
          <motion.button
            whileTap={{ scale: 0.95 }}
            className={
              " px-3 capitalize font-semibold font-stretch-150% rounded-full text-xs border bg-white/10 text-white/30 border-white/30 py-1 cursor-not-allowed"
            }
